...
const estudiante = {
  foto: "/persona.jpg", // Puedes cambiar la URL por la foto real
...
const notas = {
  ...
  otros: {
    Coro: [
      { evaluacion: "Participación", peso: 100, nota: 20 },
    ],
    Armonía: [
      { evaluacion: "Trabajo Final", peso: 100, nota: 18 },
    ],
  },
};

// Función para calcular el total acumulado de una materia
function calcularTotal(materiaNotas) {

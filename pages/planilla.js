                      ...
                      <div className='flex-1 w-full'>
                        ...
                        <div className="flex gap-2 mt-3">
                          ...
                          <button
                            ...
                            title="Añadir"
                            onClick={() => handleAdd(instrumentos, setInstrumentos, instrumentos)}
                          >
                      ...
                      <div className='flex-1 w-full'>
                        ...
                        <div className="flex gap-2 mt-3">
                          ...
                          <button
                            ...
                            className="bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded flex items-center"
                            title="Añadir"
                            onClick={() => handleAdd(teoricas, setTeoricas, teoricas)}
                          >
                            <span className="text-lg font-bold">+</span>
                          </button>
                          {teoricas.length > 1 && (
                      ...
                      <div className='flex-1 w-full'>
                        ...
                        <div className="flex gap-2 mt-3">
                          ...
                          <button
                            ...
                            className="bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded flex items-center"
                            title="Añadir"
                            onClick={() => handleAdd(otros, setOtros, otros)}
                          >
                            <span className="text-lg font-bold">+</span>
                          </button>
                          {otros.length > 1 && (
